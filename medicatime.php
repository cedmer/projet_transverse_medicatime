...
<div id="forms">
    ...
    <form>
        <table>
            ...
            <tr>
                <td><input type="button" value="add to preview" id="add_preview"></td>
                <td></td>
                <td><input type="button" value="remove from preview" id="remove_preview"></td>
            </tr>
        </table>
        <input type="button" value="new medic" id="new_medic">
    </form>
